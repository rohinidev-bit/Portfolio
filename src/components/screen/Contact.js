									...
									<div class="contact-wrapper">
										<div class="direct-contact-container">
											<ul class="contact-list">
												<li class="list-item"><i class="fa fa-map-marker fa-2x"><span class="contact-text place"><p style={{ color: "#fff", "font-family": "Lato, sans-serif", "font-size": "25px", "font-weight": "300" }}> Raipur, Chhattisgarh, 492099 </p></span></i></li>
											...
											<div className="form-wrapper">
												<div className="padded">
													...
													<ul class="social-media-list">
														...
														<a href="https://mail.google.com/mail/?view=cm&fs=1&to=rohiniverma53@gmail.com" class="contact-icon"><li>
