				...
				<div className="about" >
					...
					<div className="about-buttons padding">
						<div className="hire-me">
							<button className="about-button"><a href="https://mail.google.com/mail/?view=cm&fs=1&to=rohiniverma53@gmail.com"><p style={{ color: "#000", "font-family": "Lato, sans-serif", "font-size": "20px", "font-weight": "340" }}>Discuss a Project !</p></a>
							</button>
						</div>
